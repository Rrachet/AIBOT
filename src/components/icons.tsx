...
export function Icon({ name, size = 18 }: { name: string; size?: number }) {
  ...
  const paths: Record<string, ReactNode> = {
    ...
    plus:<><path d="M12 5v14M5 12h14"/></>, upload:<><path d="M12 16V4M8 8l4-4 4 4"/><path d="M5 20h14"/></>, bell:<><path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4"/></>, arrow:<><path d="M5 12h14M13 6l6 6-6 6"/></>, search:<><circle cx="11" cy="11" r="7"/><path d="m20 20-4-4"/></>, menu:<><path d="M4 7h16M4 12h16M4 17h16"/></>,
  };

...
export function SectionPage({ active, title, eyebrow, subtitle, action, children }: { active:string; title:string; eyebrow:string; subtitle:string; action?:string; children?:React.ReactNode }) {
